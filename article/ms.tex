...
% where the flux values $f_{n\lambda}$ are well-approximated by the given spectral model. 



% Things are Gaussian, therefore EW related.
% How does EW of a line change w.r.t. stellar parameters
% If we had a model for a single line, how could this be included.
...
% This is why we should also be able to model the EW->log(X) with a Cannon-like model.
